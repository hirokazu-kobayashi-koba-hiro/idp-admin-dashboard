export const onboardingRequestTemplate = {
  ...
  authorization_server: {
    ...
    token_endpoint: "$ISSUER/v1/tokens",
    ...
    token_introspection_endpoint: "$ISSUER/v1/tokens/introspection",
    token_revocation_endpoint: "$ISSUER/v1/tokens/revocation",
    backchannel_token_delivery_modes_supported: ["poll", "ping", "push"],
    backchannel_authentication_endpoint:
        "ISSUER/v1/backchannel/authentications",
    ...
    authorization_signing_alg_values_supported: ["RS256", "ES256", "HS256"],
    authorization_encryption_alg_values_supported: ["RSA1_5", "A128KW"],
    ...
    fapi_advance_scopes: ["write"],
  },
  client: {
    "issuer": "$ISSUER/67e7eae6-62b0-4500-9eff-87459f63fc66",
    "client_id": "$CLIENT_ID",
    ...
    "scope": "openid profile email address phone offline_access account transfers read write identity_verification_application identity_verification_delete identity_credentials_update",
    "client_name": "Initial Client",
    "client_name#ja-Jpan-JP": "初期構築クライアント",
