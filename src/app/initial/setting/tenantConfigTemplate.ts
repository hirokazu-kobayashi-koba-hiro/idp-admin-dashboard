export const tenantConfigTemplate = {
    "issuer": "${ISSUER}",
    "authorization_endpoint": "${ISSUER}/api/debug/v1/authorizations",
    "token_endpoint": "${ISSUER}/api/v1/tokens",
    ...
    "token_introspection_endpoint": "${ISSUER}/api/v1/tokens/introspection",
    "token_revocation_endpoint": "${ISSUER}/api/v1/tokens/revocation",
    "backchannel_token_delivery_modes_supported": [
        "poll",
        "ping",
        "push"
    ],
    "backchannel_authentication_endpoint": "${ISSUER}/api/v1/backchannel/authentications",
